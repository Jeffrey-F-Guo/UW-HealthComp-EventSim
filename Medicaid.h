...
typedef struct {
    ...
    uint32_t avg_latency_ms; // Running average
...
MedicaidPacket create_medicaid_packet(uint32_t id, uint32_t zone, uint32_t timestamp_ms, uint8_t complexity, uint8_t manual);
